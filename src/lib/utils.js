...
export const STATUS_OPTIONS = ["Not Started", "On Track", "At Risk", "Completed"];
...
export function getScoreBg(score) {
  if (score >= 100) return "bg-emerald-400/10 border-emerald-400/20";
  if (score >= 75) return "bg-brand-400/10 border-brand-400/20";
...
export function getStatusColor(status) {
  const map = {
    "Not Started": "bg-slate-700/50 text-slate-400 border-slate-600/30",
    "On Track": "bg-emerald-400/10 text-emerald-400 border-emerald-400/20",
    "At Risk": "bg-yellow-400/10 text-yellow-400 border-yellow-400/20",
    ...
    Locked: "bg-purple-400/10 text-purple-400 border-purple-400/20",
  };
